...
export class DashboardRiskComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.pieChartOne = this.dashboardService.pieChartOne();
    this.pieChartTwo = this.dashboardService.pieChartTwo();

    this.areaChart = this.dashboardService.areaChart();
    this.lineChart = this.dashboardService.lineChart();
    this.multiBarChart = this.dashboardService.multiBarChart();
